...
public class MiddleBackground : MonoBehaviour {
    ...
    public float parallasHovSpeed;
    public float parallasVerSpeed;
    ...
    private void parallaxHor()
    {
        ...
        transform.position += Vector3.right * (deltaX * parallasHovSpeed);
        lastCameraX = cameraTransform.position.x;
    }
    ...
    private void parallaxVer()
    {
        ...
        transform.position += Vector3.up * (deltaY * parallasVerSpeed);
